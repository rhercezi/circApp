...
{
    public class UpdatePasswordAction : IAggregateAction<PasswordUpdatedEvent, UserAggregate>
    {
        public async Task ExecuteAsync(PasswordUpdatedEvent xEvent, UserAggregate instance, bool isReplay)
        {
            if (isReplay)
            {
